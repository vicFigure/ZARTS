...
primitives_5 = OrderedDict([('primitives_normal', 14 * [PRIMITIVES_darts]),
                            ('primitives_reduct', 14 * [PRIMITIVES_darts])])
primitives_6 = OrderedDict([('primitives_normal', 14 * [PRIMITIVES_6]),
                            ('primitives_reduct', 14 * [PRIMITIVES_6])])
...
spaces_dict = {
    ...
    's6': primitives_6, # DARTS space, no None
}
